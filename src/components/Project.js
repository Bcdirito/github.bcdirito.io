...
export default class Project extends Component {
  ...
  renderDetailMessage = () => {
    ...
    else if (this.state.language === "JavaScript" || this.state.lanugage === "React") return `- This front end was built in ${this.state.language}. Click here to visit the Repo!`
    else if (this.state.language === "Heroku") return `- ${this.state.project} has been deployed! Click here to check it out!`
    else return "- Hover over an icon to learn more!"
  }
  ...
  renderMyBrews = () => {
    ...
    <div className="descriptionContent">
      ...
      <div className="detailMessage" onMouseEnter={e => this.enterHandler(e)} onMouseLeave={() => this.leaveHandler()} >
      <a href="https://github.com/Bcdirito/myBrews" target="_blank" rel="noopener noreferrer"><img src={rubyIcon} alt="rubyIcon" name="Ruby" /></a>
      <br/>
      {this.state.language !== "" ? this.renderDetailMessage() : null}</div>
      <br/>
    </div>)
  }
  ...
  renderGoodWork = () => {
    return (
      <div className="descriptionContent">
        ...
        <br/>
        <a href="https://github.com/Bcdirito/good_work_front" target="_blank" rel="noopener noreferrer"><img src={reactIcon} alt="javaScriptIcon" name="React" onMouseEnter={e => this.enterHandler(e)} onMouseLeave={() => this.leaveHandler()} /></a>
        <a href="https://github.com/Bcdirito/good_work_back" target="_blank" rel="noopener noreferrer"><img src={railsIcon} alt="railsIcon" name="Ruby on Rails" onMouseEnter={e => this.enterHandler(e)} onMouseLeave={() => this.leaveHandler()} /></a>
      </div>
      )
  }
